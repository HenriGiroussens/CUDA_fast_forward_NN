...
#include "model_loading/load_weights.hh"

int main() {

    std::string mod = "get_model";
    ...
    if (mod == "dense") {
        ...
        std::vector<Layer*> layers({&dense_1, &act_1, &dense_2, &act_2});
    ...
    if (mod == "conv") {
        ...
        Conv2D conv_1(5, 5, 2, K, B1, 2, 3, true);
        Activation act_1("relu", 9, 2);
        Dense dense_2(9, 2, W2, B2);
        Activation act_2("softmax", 2, 1);
        std::vector<Layer*> layers({&conv_1, &act_1, &dense_2, &act_2});
        Model model(layers, 4, 5, 2);
    ...
    if (mod == "small_LeNet") {
        ...
        Conv2D conv_1(5, 5, 2, K, B1, 2, 3, false);
